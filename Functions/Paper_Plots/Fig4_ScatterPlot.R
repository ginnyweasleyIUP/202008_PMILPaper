...
abline(lm.out, lwd = 4, col = "#B2182B")
#lines(lowess(scatter_data$mean_temp, scatter_data$d18Oc, f = 2/3, delta = 0.01*diff(range(scatter_data$mean_temp, na.rm = T))), lwd = 4, 
#      col = adjustcolor("#B2182B", alpha.f = 0.5))
...
abline(lm.out, lwd = 4, col = "#B2182B")
#lines(lowess(scatter_data$latitude, scatter_data$diff_full, f = 2/3, delta = 0.01*diff(range(scatter_data$latitude, na.rm = T))), lwd = 4, 
#      col = adjustcolor("#B2182B", alpha.f = 0.5))
mtext(text = "latitude  (°N)",side = 1,line = 2)
